...
/**
 * For endpoints that need it, determine the client name from the client's comment
 */
if ((isset($_GET['topClients']) || isset($_GET['getQuerySources']) || isset($_GET['topClientsBlocked']) || isset($_GET['getClientNames'])) && $auth) {
